...
#  19g. tests/scripts/test-rerun-gate.sh                         (P8 rerun-failed-gate consumer; eligibility + dispatch + versioned output + audit trail)
...
run_fixture "${REPO_ROOT}/tests/scripts/test-cap-entry-help-surface.sh" "cap-entry help surface"
run_fixture "${REPO_ROOT}/tests/scripts/test-cap-entry-unknown-command.sh" "cap-entry unknown command catch"
run_fixture "${REPO_ROOT}/tests/scripts/test-cap-entry-shortcuts.sh" "cap-entry namespace shortcuts"
run_fixture "${REPO_ROOT}/tests/scripts/test-cap-workflow-static-outside-project.sh" "cap workflow static list outside project"
run_fixture "${REPO_ROOT}/tests/scripts/test-cap-provider-doctor.sh" "cap provider doctor read-only inspector"
run_fixture "${REPO_ROOT}/tests/scripts/test-cap-workflow-cli-fail-fast.sh" "cap workflow run --cli fail-fast guard"
...
run_fixture "${REPO_ROOT}/tests/scripts/test-rerun-gate.sh" "rerun-failed-gate consumer (P8 #8)"
