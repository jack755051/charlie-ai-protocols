...
| # | 檔案 | 層級 | 是什麼 | 規範對象 |
|---|---|---|---|---|
| 1 | `policies/workflow-constitution.md` | **元憲法** | runtime 跑 workflow 時的最高治理規則（phase 上限、summary-first handoff、artifact tiering、stop-when-goal-satisfied 等） | 所有 workflow（含 #2 自己） |
...
1. `policies/cap-execution-model.md`
2. `policies/workflow-executor-selection.md`
