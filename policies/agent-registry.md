...
>
> 上層原則：`agent-skills/` 為唯讀官方 baseline，由 CAP release 維護；自訂走 project / shared layer。詳見 [`policies/agent-skills-baseline.md`](agent-skills-baseline.md) 與 [`AGENT-SKILLS-CUSTOMIZATION.md`](../development-records/archive/docs-cap/AGENT-SKILLS-CUSTOMIZATION.md)。
